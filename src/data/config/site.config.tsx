...
export const DATA = {
  ...
  career:
    "私 राहुल, Started my dev journey at 17, hacking away in 11th grade—been building, breaking, or learning ever since and it's been a rollercoaster ride since then.",
  careerFull:
    "私 राहुल, Started my dev journey at 17, hacking away in 11th grade—been building, breaking, or learning ever since and it's been a rollercoaster ride since then.\n\nBack in 2021, I was just an Higher School student with little tech knowledge. When the pandemic hit, everything moved online, and I got a my first laptop for attending classes. This led me to start my learning tech from HTML, CSS. \n\nIt's all started from my uncle who wanted teach some student , and i was one of them he started with how the web works under the hood in real, and i got inspired. Since then i never stoped learning buckled the seatbelt stared my ride in web. I then built some succesful project.\n\nThat’s how the journey began, and trust me—the ride’s just getting started. 🚀",
  avatarUrl: "/me.jpeg",
  connect:
  ...
  contact: {
    ...
    social: {
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://linkedin.com/in/rxhul18",
        icon: Icons.linkedin,
